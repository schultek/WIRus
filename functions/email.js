...
Mit deiner Bestätigung erhält ${user.name} ${action.points} Punkte für das Helfen bei deiner Aktion '${action.title}'. Du erhälst diese Email, da ${user.name} bei deiner Aktion über unsere Partner-Platform ${platform.name} mitgemacht hat.

Du musst nichts weiter machen, als auf den folgenden Link zu drücken. Von dir werden keine weiteren Daten gespeichert.
Mit deinem Klick trägst du dazu bei, dass mehr Helfer dich und andere Hilfesuchende unterstützen.

Bestätige hier: ${link};


Copyright WIRus © 2020
WIRus ist ein Projekt des #wirvsvirus Hackathons zur Corona-Krise
    `
}
				...
				<td style="word-break: break-word; vertical-align: top;" valign="top">
									...
									<div style="width:100% !important;">
										...
										<div
											...
											<div align="center" class="img-container center autowidth"
												...
												<div style="font-size:1px;"> </div><img align="center"
													alt="I'm an image" border="0" class="center autowidth"
													src="${platform.logo}"
													style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 154px; display: block;"
													title="${platform.name}" width="154" />
					...
					<div style="background-color:transparent;">
						<div class="block-grid"
							style="Margin: 0 auto; min-width: 320px; max-width: 640px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #ffffff;">
							<div
								style="border-collapse: collapse;display: table;width: 100%;background-color:#ffffff;background-image:url('https://wirus-app.firebaseapp.com/image/bg-shade.jpg');background-position:center top;background-repeat:repeat">
								<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:640px"><tr class="layout-full-width" style="background-color:#ffffff"><![endif]-->
								...
								<div class="col num12"
									...
									<div style="width:100% !important;">
										...
										<div
											...
											<div
												style="color:#555555;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;line-height:1.2;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;">
												<div
													...
													<p
														...
														<span style="color: #00a676;"><strong>Hilf ${user.name}, anderen zu
																helfen!</strong></span></p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											...
											<div
												...
												<div
													style="line-height: 1.2; font-size: 12px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; color: #555555; mso-line-height-alt: 14px;">
													<p
														style="font-size: 34px; line-height: 1.2; word-break: break-word; text-align: center; font-family: inherit; mso-line-height-alt: 41px; margin: 0;">
														<span style="font-size: 34px; color: #2a272b;"><strong>Bestätige
																${user.name}'s helfen bei der Aktion '${action.title}'</strong></span></p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											...
											<div
												...
												<div
													...
													<p
														...
														<span style="font-size: 16px; color: #2a272b;">Mit deiner
															Bestätigung erhält ${user.name} ${action.points} Punkte für das Helfen bei deiner
															Aktion <strong>'${action.title}'</strong>. Du erhälst diese
															Email, da ${user.name} bei deiner Aktion über unsere Partner-Platform
															<a href="${platform.url}" style="text-decoration: underline;" target="_blank"><strong>${platform.name}</strong></a>
															mitgemacht hat.</span></p>
													<p
														style="line-height: 1.5; word-break: break-word; text-align: center; font-family: inherit; mso-line-height-alt: NaNpx; margin: 0;">
														 </p>
													<p
														style="line-height: 1.5; word-break: break-word; text-align: center; font-family: inherit; font-size: 14px; mso-line-height-alt: 21px; margin: 0;">
														<span style="font-size: 14px;"><span style="color: #2a272b;">Du
																musst nichts weiter machen, als auf 'Bestätigen' zu
																drücken. Von dir werden keine weiteren Daten
																gespeichert.</span></span></p>
													<p
														style="line-height: 1.5; word-break: break-word; text-align: center; font-family: inherit; font-size: 14px; mso-line-height-alt: 21px; margin: 0;">
														<span style="font-size: 14px; color: #2a272b;">Mit deinem Klick
															trägst du dazu bei, dass mehr Helfer dich und andere
															Hilfesuchende unterstützen.</span></p>
													<p
											...
											<div align="center" class="button-container"
												...
												<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${link}" style="height:45pt; width:157.5pt; v-text-anchor:middle;" arcsize="100%" stroke="false" fillcolor="#00a676"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a
													href="${link}"
													style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #00a676; border-radius: 60px; -webkit-border-radius: 60px; -moz-border-radius: 60px; width: auto; width: auto; border-top: 1px solid #00a676; border-right: 1px solid #00a676; border-bottom: 1px solid #00a676; border-left: 1px solid #00a676; padding-top: 12px; padding-bottom: 16px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;"
													target="_blank"><span
														style="padding-left:32px;padding-right:32px;font-size:16px;display:inline-block;"><span
															style="font-size: 16px; margin: 0; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>Bestätigen</strong></span></span></a>
											...
											<div align="center" class="img-container center autowidth"
												...
												<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img
													...
													src="https://wirus-app.firebaseapp.com/image/mail-graph.png"
										...
										<div
											...
											<div align="left" class="img-container left autowidth"
												...
												<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="left"><![endif]--><img
													alt="WIRus" border="0" class="left autowidth"
													src="${logo}"
													style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 154px; display: block;"
													title="WIRus" width="154" />
												<!--[if mso]></td></tr></table><![endif]-->
											</div>
											<!--[if (!mso)&(!IE)]><!-->
										</div>
										...
										<div
											...
											<div
												...
												<div
													...
													<p
														style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">
														<strong>WIRus</strong> ist ein Projekt des #wirvsvirus
														Hackathons zur Corona-Krise</p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											<!--[if (!mso)&(!IE)]><!-->
								...
								<div class="col num4"
									...
									<div style="width:100% !important;">
										...
										<div
											...
											<div
												style="color:#555555;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;line-height:1.5;padding-top:0px;padding-right:48px;padding-bottom:28px;padding-left:0px;">
												<div
													style="line-height: 1.5; font-size: 12px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; color: #555555; mso-line-height-alt: 18px;">
													<p
